...
**_I am currently ranked #4 on the page mentioned above (Commits)..._**
...
- **_GNU/Bash: Es una interfaz de usuario de línea de comandos popular, específicamente en un shell de Unix; así como un reconocido lenguaje de scripting._**
