# [![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=35&pause=1000&color=F70000&center=true&vCenter=true&random=false&width=1000&height=40&lines=WELCOME+TO+MY+PERSONAL+PROFILE+TO+EVERYONE!)](https://git.io/typing-svg)
...
## ESPECIAL DE HALLOWEEN (CREADO A FINALES DE OCTUBRE DE ESTE AÑO, DESDE EL 31 DE OCTUBRE)
...
- 📫 **_How to contact me: If you have any suggestions, please send them to one of my contacts:_**
  ...
  - **_+56979628796 (For personal recalls or WhatsApp)._**
...
- 📫 **_Cómo contactarme: Ante cualquier sugerencia, hacerles llegar a uno de mis contactos:_**
  ...
  - **_+56979628796 (Para llamadas o por WhatsApp)._**
...
- **_Android: Es un sistema operativo móvil basado en el núcleo de dicho sistema operativo Linux y otros software de código abierto._**
...
- **_Git: Es un software de control de versiones diseñado por el ingeniero Finlandés-Estadounidense Linus Torvalds, pensando en la eficiencia, la confiabilidad y compatibilidad del mantenimiento de versiones de aplicaciones cuando éstas tienen un gran número de archivos de código fuente._**
...
- **_Spring Boot: Es una herramienta que acelera y simplifica el desarrollo de microservicios y aplicaciones web con Spring Framework gracias a sus tres funciones fundamentales:_**
...
- **_Unity: Es un motor de videojuego multiplataformas creado por Unity Technologies, anunciado y lanzado por primera vez en junio de 2005 en la Conferencia Mundial de Desarrolladores de Apple como motor de juegos para Mac OS X._**
...
### Modo cápsula minera (Gruvbox mode):
...
### Modo jugo-refrescante (JuicyFresh mode):
...
### Modo amante_oscuro (Dark_lover mode)
